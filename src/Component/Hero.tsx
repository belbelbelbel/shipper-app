                ...
                <div className='w-full mx-auto h-[20%] justify-center flex flex-col bg-transparent '>
                    <div className='w-[80%] mx-auto flex items-center relative z-50 justify-between'>
                        ...
                        <div className='flex gap-20 text-white'>
                            <button className='bg-black px-10 py-1.5 shadow-2xl rounded-[10px] ' onClick={() => navigate('/signup')}>Sign Up</button>
                            <button className='bg-black px-10 py-1.5 shadow-2xl rounded-[10px]'>Sign In</button>
                        </div>
                    </div>
                </div>
